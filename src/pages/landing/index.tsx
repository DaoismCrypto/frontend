...
const ImpactCard = (impact: Impact, isLeft: boolean) => {
  return (
    <Box display='flex' width='70%' alignSelf={isLeft ? 'flex-start' : 'flex-end'} mb={8}>
      <Card sx={{ pb: 0, mb: 0, borderRadius: '15px' }}>
        ...
        <CardContent sx={{ py: 0, my: 0 }}>
          <Grid container sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Grid item xs={12} ml={isLeft ? 5 : 0} sm={isLeft ? 8 : 9} order={isLeft ? 2 : 1}>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Typography mb={6} fontFamily='DM Sans' variant='body1'>
            Powered by blockchain Lorum Ipsum is simply dummy text of the printing and typesetting
          </Typography>
        ...
        {/* Image starts */}
        <Grid item xs={12} sm={6} justifyContent='center' display='flex' px={6} py={{ xs: 5, md: 15 }}>
          <Box
            component='img'
            sx={{
              height: 'auto',
      ...
      >
        ...
        <Grid container px={5} py={8}>
          ...
          <Grid item xs={4} padding={2} display='flex' alignItems='center' justifyContent='flex-end'>
            <Typography fontFamily='DM Sans' variant='caption' mb={3} textAlign='right'>
              View more tokens
            </Typography>
          </Grid>
          <Grid item xs={12}>
                  ...
                  {rows.map(row => (
                    ...
                    >
                      ...
                      <TableCell align='right'>
                        <Typography color={row.dayChange > 0 ? 'success.main' : 'error.main'}>
                          {row.dayChange}%
                        </Typography>
                      </TableCell>
                    </TableRow>
      ...
      >
        ...
        >
          ...
          <Stack direction='column' spacing={2}>
            {impacts.map((impact, index) => ImpactCard(impact, index % 2 === 0))}
          </Stack>
        </Grid>
      </Grid>
    </>
